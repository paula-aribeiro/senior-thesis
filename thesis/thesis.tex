...
% ARRUMAR isopleta aqui quando estiver terminada
...
As Figuras \ref{fig:LR_A1_hipo}, \ref{fig:LR_A1_hiper} e \ref{fig:LR_A1_total} a seguir mostram os gráficos de valores preditos versus esperados para a temperatura A1.

\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1_hipo.png}
  \caption{Arrumar}
  \label{fig:LR_A1_hipo}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1_hiper.png}
  \caption{Arrumar}
  \label{fig:LR_A1_hiper}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1_total.png}
  \caption{Arrumar}
  \label{fig:LR_A1_total}
\end{figure}
%ARRUMAR P/ FICAR LADO A LADO, UMA LEGENDA SÓ
...
As Figuras \ref{fig:LR_A1prime_hipo}, \ref{fig:LR_A1prime_hiper} e \ref{fig:LR_A1prime_total} a seguir mostram os gráficos de valores preditos versus esperados para a temperatura A1'.

\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1prime_hipo.png}
  \caption{Arrumar}
  \label{fig:LR_A1prime_hipo}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1prime_hiper.png}
  \caption{Arrumar}
  \label{fig:LR_A1prime_hiper}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A1prime_total.png}
  \caption{Arrumar}
  \label{fig:LR_A1prime_total}
\end{figure}
%ARRUMAR P/ FICAR LADO A LADO, UMA LEGENDA SÓ
...
As Figuras \ref{fig:LR_A3_hipo}, \ref{fig:LR_A3_hiper} e \ref{fig:LR_A3_total} a seguir mostram os gráficos de valores preditos versus esperados para a temperatura A1'.

\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A3_hipo.png}
  \caption{Arrumar}
  \label{fig:LR_A3_hipo}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A3_hiper.png}
  \caption{Arrumar}
  \label{fig:LR_A3_hiper}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/A3_total.png}
  \caption{Arrumar}
  \label{fig:LR_A3_total}
\end{figure}
%ARRUMAR P/ FICAR LADO A LADO, UMA LEGENDA SÓ
...
Avaliando-se o efeito da taxa de aprendizado e do número de neurônios na camada intermediária, obteve-se os
gráficos das Figuras \ref{img/test1.png}, \ref{img/test01.png} e \ref{img/test001.png} a seguir.

\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/test1.png}
  \caption{Arrumar}
  \label{fig:test1}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/test01.png}
  \caption{Arrumar}
  \label{fig:test01}
\end{figure}
%
\begin{figure}
  \includegraphics[width=0.3\textwidth]{img/test001.png}
  \caption{Arrumar}
  \label{fig:test001}
\end{figure}
...
%ARRUMAR: INSERIR GRÁFICOS PERDA X ITERAÇÕES
...
%ARRUMAR: INSERIR GRÁFICOS PREDITO X ESPERADO

Nota-se que as predições para seis e doze neurônios são próximas e, considerando o tempo computacional, a primeira opção é, de fato, o ponto ótimo. Definindo todos os parâmetros, foram plotadas isopletas variando um dos elementos e fixando os demais, com o intuito de se comparar os valores obtidos pelo Thermo-Calc\textregistered{} com as predições do modelo.
