...
%ARRUMAR: INSERIR GRÁFICOS PREDITO X ESPERADO, PRECISA PLOTAR NOVOS COM OS EIXOS CERTOS
...
% ARRUMAR: inserir \ref do gráfico de predito x esperado da NN

Para baixas concentrações de Silício o modelo também foi destoante.
